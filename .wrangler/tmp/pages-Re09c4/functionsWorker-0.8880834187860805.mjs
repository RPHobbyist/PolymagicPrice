...
async function onRequest(context) {
  ...
  if (path.endsWith(".swp") || path.endsWith(".bak") || path.endsWith(".save") || path.endsWith("~") || path.endsWith(".docker") || path.endsWith(".example") || path.endsWith(".test")) {
    return new Response("Not Found", { status: 404 });
  }
  ...
  if (contentType.includes("text/html")) {
    ...
    if (config) {
      response = new HTMLRewriter().on("title", {
        element(e) {
      ...
      response = new HTMLRewriter().on('link[rel="canonical"]', {
        element(e) {
          e.setAttribute("href", canonicalUrl);
        }
      }).on('meta[property="og:url"]', {
...
// ../.wrangler/tmp/pages-Re09c4/functionsRoutes-0.27601733344610324.mjs
var routes = [
  {
    routePath: "/",
    mountPath: "/",
...
// C:/Users/Ravi/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/Ravi/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// C:/Users/Ravi/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// C:/Users/Ravi/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../.wrangler/tmp/bundle-2cYP1E/middleware-insertion-facade.js
...
// C:/Users/Ravi/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/common.ts
...
// ../.wrangler/tmp/bundle-2cYP1E/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8880834187860805.mjs.map
