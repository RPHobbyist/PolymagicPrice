    ...
    const sections = [
        ...
        },
        {
            ...
            items: [
                ...
                "AI Configuration: If you're using the Local AI Assistant, configure the Ollama connection settings here — model name, server address, and temperature (creativity level). You can also define custom system prompts that tailor the AI's responses to your shop's specific terminology and workflows",
